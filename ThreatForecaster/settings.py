"""
Django settings for ThreatForecaster project.
...
SECRET_KEY = 'django-insecure-v4cd@l#=ospoewv4hostz)=$@g@8qlo9dxo3qmj!wg2wxm&cq4'
...
WSGI_APPLICATION = 'ThreatForecaster.wsgi.application'
